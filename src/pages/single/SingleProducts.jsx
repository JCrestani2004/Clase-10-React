        ...
        <div className="row g-4 single-product">
          <div className="col-xl-6">
            <div className="single-carousel owl-carousel">
              <div className="single-item" data-dot="<img class='img-fluid' src='img/product-4.png' alt=''>">
                <div className="single-inner bg-light rounded">
                  <img src="img/product-4.png" className="img-fluid rounded" alt="Image" />
                </div>
              </div>
              <div className="single-item" data-dot="<img class='img-fluid' src='img/product-5.png' alt=''>">
                <div className="single-inner bg-light rounded">
                  <img src="img/product-5.png" className="img-fluid rounded" alt="Image" />
                </div>
              </div>
              <div className="single-item" data-dot="<img class='img-fluid' src='img/product-6.png' alt=''>">
                <div className="single-inner bg-light rounded">
                  <img src="img/product-6.png" className="img-fluid rounded" alt="Image" />
                </div>
              </div>
              <div className="single-item" data-dot="<img class='img-fluid' src='img/product-7.png' alt=''>">
                <div className="single-inner bg-light rounded">
                  <img src="img/product-7.png" className="img-fluid rounded" alt="Image" />
                </div>
              </div>
              <div className="single-item" data-dot="<img class='img-fluid' src='img/product-3.png' alt=''>">
                <div className="single-inner bg-light rounded">
                  <img src="img/product-3.png" className="img-fluid rounded" alt="Image" />
                </div>
              </div>
          ...
          <div className="col-xl-6">
            ...
            <a href="#" className="btn btn-primary border border-secondary rounded-pill px-4 py-2 mb-4 text-primary"><i className="fa fa-shopping-bag me-2 text-white" /> Add to cart</a>
          </div>
